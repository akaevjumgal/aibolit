...
export default function PersonalAccountPage() {
   ...
   const Links = [<a key={'a1'} href="#PersonaData">ЛИЧНЫЕ ДАННЫЕ</a>,<a key={'a2'} href="#Pets">МОИ ПИТОМЦЫ</a>,<a key={'a3'} href="#Reseption">ЗАПИСЬ НА ПРИЕМ</a>,<a key={'a4'} href="#">ВЫЙТИ</a>]
