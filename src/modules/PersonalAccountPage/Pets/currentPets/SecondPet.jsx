    ...
    <div style={{alignSelf:'center'}} className='Card_Flex_Item3'>
        <div className='Card_Info'>
            <p className='Card_Pets_Info'>Медицинская карта</p>
                <div>
                    <p style={{marginTop:10}}>Медицинскую карту заводят при первом посещении клиники и обновляют при каждом обращении. Здесь вы сможете посмотреть и скачать актуальную карту в формате pdf</p>
                </div>
